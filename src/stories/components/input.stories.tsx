...
export const Masked: Story = {
  ...
  play: async ({ args, canvasElement, step }) => {
    ...
    await step("Type", async () => {
      ...
      await expect(args.onChange).toHaveBeenNthCalledWith(6, "12/1M/JJJJ");
      await expect(args.onChange).toHaveBeenNthCalledWith(7, "12/12/JJJJ");
      await expect(args.onChange).toHaveBeenNthCalledWith(8, "12/12/2JJJ");
